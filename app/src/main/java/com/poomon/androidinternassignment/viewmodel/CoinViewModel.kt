...
class CoinViewModel: ViewModel() {
    ...
    init {
        // Dummy data
        for(x in 0..15) {
            list1.add(Coin("BTC", "Lorem ipsum dolor sit amet, per no facilisi conceptam adversarium." +
        ...
        for(x in 0..20) {
            list2.add(Coin("ETH", "Do not go gentle into that good night, " +
        ...
        for(x in 0..10) {
            list3.add(Coin("ETH", "Demons run when a good man goes to war " +
